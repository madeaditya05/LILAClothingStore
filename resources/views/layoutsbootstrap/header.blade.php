...
<head>
  ...
  {{-- Local Assets (pastikan file ini sudah ada di public/assets/css/) --}}
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/vendor.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/style.css') }}">
  {{-- Jika ada file style.css bawaan langsung dari template juga taruh di sini --}}
  {{-- <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/namafilelain.css') }}"> --}}

  {{-- Google Fonts --}}
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link
    href="https://fonts.googleapis.com/css2?family=Jost:ital,wght@0,300;0,400;0,500;1,300;1,400;1,500&family=Marcellus&display=swap"
    rel="stylesheet">
</head>
    ...
    <div class="search-popup-container">
      ...
      <ul class="cat-list">
        <li class="cat-list-item">
          <a href="{{ route('pants') }}" title="Pants">Pants</a>
        </li>
        <li class="cat-list-item">
          <a href="{{ route('shirt') }}" title="Shirt">Shirt</a>
        </li>
        <li class="cat-list-item">
          <a href="#" title="Woman's-Suit">Woman's-Suit</a>
        </li>
      </ul>
    ...
    <div class="row justify-content-between align-items-center w-100">
      ...
      <div class="col-3 col-lg-auto">
        <ul class="list-unstyled d-flex m-0 align-items-center">
          ...
          <li class="nav-item dropdown">
            <a href="#" class="mx-2 dropdown-toggle" role="button" id="dropdownProfile" data-bs-toggle="dropdown" aria-expanded="false">
